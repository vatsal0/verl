...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=$HOME/data/encoded_format/train.parquet \
    data.val_files=$HOME/data/encoded_format/test.parquet \
    data.max_prompt_length=2048 \
    data.max_response_length=512 \
    data.train_batch_size=$BATCH_SIZE \
    data.filter_overlong_prompts=True \
    data.truncation='error' \
    actor_rollout_ref.model.path=vatsalb/qwen_4b_length_penalty_step1100 \
    ...
    trainer.experiment_name='format encoded qwen 3b' \
    ...
    trainer.default_local_dir=/home/user/checkpoints/encoded_format \
