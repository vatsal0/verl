...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=$HOME/data/blind/train.parquet \
    data.val_files=$HOME/data/blind/test.parquet \
    ...
    trainer.experiment_name='blind qwen 3b' \
    ...
    trainer.default_local_dir=/home/user/checkpoints/blind \
